...
* Packaged by default in [ServiceStack.dll](https://github.com/mythz/ServiceStack/downloads)
* Available to download separately as a stand-alone [ServiceStack.Redis.dll](https://github.com/mythz/ServiceStack.Redis/downloads) 
...
Downloads for Redis Server Windows builds [can be found here](http://code.google.com/p/servicestack/wiki/RedisWindowsDownload).

# Getting Started with the C# Redis client

###[C# Redis Client wiki](https://github.com/mythz/ServiceStack.Redis/wiki)
